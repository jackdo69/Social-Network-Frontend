...
export default function FriendSuggestions() {
    ...
    useEffect(() => {
        ...
        for (let f of suggestionsUpdated) {
                ...
                return (
                    <CustomPaper key={s.id} variant="outlined">
                        <div className={classes.info}>
                            ...
                            {s.isSent ? <Button variant="contained" disabled>Pending</Button> : <Button color="primary" onClick={() => addFriend({ id: s.id, username: s.username })}>Add Friend</Button>}
